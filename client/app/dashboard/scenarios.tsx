...
export default function ScenarioList({
  ...
  const gradientMap = {
    ...
    orange:
      'from-orange-800 to-orange-400 dark:from-orange-500 dark:to-orange-900',
  ...
  const hoverMap = {
    ...
    green:
      'hover:outline-green-400 hover:bg-green-50 hover:text-green-400 dark:hover:outline-green-800 dark:hover:bg-green-500 dark:hover:text-black',
    orange:
      'hover:outline-orange-400 hover:bg-orange-50 hover:text-orange-400 dark:hover:outline-orange-800 dark:hover:bg-orange-500 dark:hover:text-black',
